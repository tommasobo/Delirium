...
/**
 * Implementation of EntitiesInfoStore with protected getters and a clone constructor
...
public class EntitiesInfoStoreImpl implements EntitiesInfoStore {
     ...
     * @param movementInfo Entity's movement informations, optional empty if the entity cannot move
     * @param life Entity's life amount
     * @param lifePattern Entity's life pattern
     * @param shootInfo Entity's shoot informations, optional empty if the entity cannot fire
     * @param contactDamage Entity's contact damage amount, optional empty if the entity not have contact damage
     * @param entityType The view representation of the entity
     */
    public EntitiesInfoStoreImpl(final int code, final Position position, final Optional<MovementInfoStore> movementInfo, final int life,
    ...
    /**
     * 
     * @param e EntitiesInfoStore to copy
     */
