...
public interface Hero {
    ...
    public static final ModelPosition INITIAL_POSITION = new ModelPosition(new FisicalProprieties(new Point(20, 20), new Dimension(40, 60), 10), ModelDirections.RIGHT);
